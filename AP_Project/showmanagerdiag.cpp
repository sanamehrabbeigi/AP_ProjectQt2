    ...
    QWidget(parent)
{
    ...
    selectIDButton = new QPushButton("Apply ID");
    IDLineEdit = new QLineEdit();
    IDLineEdit->setPlaceholderText("Enter ID");
    ...
    L4 -> addWidget(IDLineEdit);
    L4 -> addWidget(selectIDButton);
    ...
    connect(selectIDButton, SIGNAL(clicked(bool)), this, SLOT(selectIDPressed()));
...
void showManagerDiag::selectIDPressed()
{
    id = IDLineEdit->text();
...
void showManagerDiag::btn_1_pressed()
{
...
void showManagerDiag::btn_2_pressed()
{
...
void showManagerDiag::btn_3_pressed()
{
...
void showManagerDiag::btn_4_pressed()
{
...
void showManagerDiag::btn_5_pressed()
{
...
void showManagerDiag::btn_6_pressed()
{
...
void showManagerDiag::btn_7_pressed()
{
...
void showManagerDiag::btn_exit_pressed()
{
...
void showManagerDiag::btn_showPicture_pressed()
{
    IDLineEdit->show();
    selectIDButton->show();
